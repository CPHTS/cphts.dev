export default function Conduct() {
  return (
    <main>
      ...
      <p>
        All participants of Copenhagen.ts are expected to abide by our Code of
        Conduct, both online and during in-person events that are hosted and/or
        associated with Copenhagen.ts.
      </p>
      ...
      <p>
        ...
        <a href="mailto:safety@cphts.dev">safety@cphts.dev</a>. All reports will
        be reviewed and investigated and will result in a response that is
        deemed necessary and appropriate to the circumstances. Further details
      ...
      <p>
        ...
        <a href="https://dev.to/code-of-conduct">dev.to</a>.
      </p>
    </main>
  );
}
